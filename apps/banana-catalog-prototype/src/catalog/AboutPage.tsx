          ...
          <div className="about-page__body">
            <section className="about-page__section" aria-labelledby="what">
              ...
              <div className="about-page__prose">
                <p>
                  BANANASUTRA is a living collection of surreal, philosophical songs. Every song has a sutra, a topic,
                  sometimes a muse, sometimes a character, and a short paragraph on why it exists. The collection is
                  meaning-first: not sorted by genre or mood, but by the question each song is trying to ask.
                </p>
                <p>
                  I invented the sutras to help me remember what matters. The corporate algorithm wants us small. Empathy
                  gets called weak. Lying is fair game. The seven sutras are my compass, seven north stars I can defend
                  and return to. They aren&apos;t taxonomy. They&apos;re a tool.
                </p>
              </div>
            </section>
            ...
            <section className="about-page__section" aria-labelledby="who">
              ...
              <div className="about-page__prose">
                <p>
                  Hi. My given name is Céline. But(t) you can call me sutra mama, or banana, if it amuses you.
                  I&apos;m curious, kind, silly, nerdy, geeky, and very human. I invented the sutras to help me remember
                  what matters in a world gone bananas, and I write songs that help me (and maybe you) be conscious and
                  caring, i.e. sane and happy. Because I agree with Frank Zappa: music is the only religion that delivers
                  the goods.
                </p>
              </div>
            </section>
            ...
            <section className="about-page__section about-page__section--colophon" aria-labelledby="colophon">
              ...
              <p className="about-page__colophon-text">
                Lyrics inspired by human stories. Music brewed with Suno, then a French-American voiceover dub. App
                powered by Airtable, Python, and JSON, served as a React and TypeScript (Vite + React Router) SPA.
                Assisted by Cursor and Claude. Embeds courtesy of SoundCloud and YouTube. Catalog numbers, filters, and
                embeds reflect a dated export from that stack, not a live mirror of SoundCloud or YouTube. The site
                footer shows the snapshot date.
              </p>
            </section>
          </div>
        </article>
